        ...
        <center>
            ...
            %>
                <tr height='190' class="cen | atr">
                    ...
                    <td class=".atd"><%= result.getString("bookname")%></td>
                    <td class=".atd"><%= result.getString("bookname")%></td>
                    <td class=".atd"><%= result.getString("bookname")%></td>
                    <td class=".atd"> </td>
                    <td class=".atd"> <%= result.getString("price")%></td>
                    <td class=".atd">
                    ...
                    <td class=".atd">
                        <input type="text" name="pop_out" value="30" readonly="readonly" style="text-align:center;"
                        size="7" />
                    </td>
                    <td class=".atd">
                        <button>구매취소</button>
                        <button style="margin-top: 20px;">수정</button>
                    </td>
                </tr>
    <%
	rowCount++;
