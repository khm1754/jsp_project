...
<%
   ...
   Statement stmt = null;
    StringBuffer SQL = new StringBuffer("insert into Book(tClass_Name, tBook_Name, tPublish, tAuthor, tPrice,  tDept, tBook_info, tBook_num, tfile) "); 
    SQL.append("values (?, ?, ?, ?, ?, ?, ?, ?, ?)");
   ...
   String driverName = "org.gjt.mm.mysql.Driver";
    ...
    try {
     ...
     String Class_Name            = multi.getParameter("tClass_Name");
      String my_image = multi.getFilesystemName("Book_Image");
